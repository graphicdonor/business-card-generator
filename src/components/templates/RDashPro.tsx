  ...
  return (
    ...
    >
      ...
      <g clipPath="url(#rdpro-left-panel-clip)">
        ...
        {/* ── Phone – viewBox 12×12 → 20×20 box (scale 1.67) ── */}
        {hasPhone && (
          <g transform={`translate(60, ${phoneY})`}>
            ...
            <text x={26} y={15} fill={navy} fontSize={17 * pScale} fontFamily={font}>
              {data.phone || data.mobile}
            </text>
          </g>
        )}

        {/* ── Address – viewBox 6.1×9.06 → 20×20 box (scale 2.21, centered horiz.) ── */}
        {hasAddress && (
          <g transform={`translate(60, ${addrTopY - 20})`}>
            <g transform="translate(3, 0) scale(2.21)">
              <path
